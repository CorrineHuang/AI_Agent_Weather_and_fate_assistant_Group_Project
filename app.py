...
def get_card_info(card_name):
    ...
    analysis = generate_analysis(f"According to Tarot theory, the card {card_name}: {tarot_info}. Please generate a detailed analysis of love, career, and financial aspects in 10-20 words.")
